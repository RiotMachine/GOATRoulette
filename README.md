...
The schema is intentionally 'flat.' This accomodates the wide range of league structures. Views exist to give topography to this flat structure. In-season tournaments, pool play, and non-week-based regular seasons are all permitted.
